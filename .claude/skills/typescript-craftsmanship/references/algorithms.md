...
function searchIndex(index: readonly SearchableCard[], query: string): DeckCard[] {
...
if (colorFilter) activeFilters.push(c => c.colorIdentity.includes(colorFilter));
...
async function preloadImages(urls: readonly string[]): Promise<Map<string, boolean>> {
